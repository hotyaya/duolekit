...
public class VdocrecvId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5487209313932714869L;
	...
	/** full constructor */
	public VdocrecvId(Integer docid, String type, String docsenddate,
			String docsendtime, String docsender, String doccaption,
			String doccode, String contact, String phone, String baseurl,
			String url, String indate, String intimestamp, String ishidden,
			String transmitter, String recvdate, String opertimestamp,
			String recvTag, String memo, String triggertime, String isok,
			String oktimestamp, String okmemo) {
		this.docid = docid;
		this.type = type;
