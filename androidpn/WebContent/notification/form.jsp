...
<tr>
	<td>Title:</td>
	<td><input type="text" id="title" name="title" value="我的测试！ " style="width:380px;" /></td>
</tr>
<tr>
	<td>Message:</td>
	<td><textarea id="message" name="message" style="width:380px; height:80px;" >钱可多提示您，股市马上要大涨了!</textarea></td>
</tr>
<%--
<tr>
	<td>Ticker:</td>
