...
public class PropertiesUserManagerFactory implements UserManagerFactory {
    ...
    private String userpassword = "";//20140207
    
    private String path = "";//20140207
    ...
    public UserManager createUserManager() {
        if (userDataURL != null) {
        	...
        	//20140207
            return new PropertiesUserManager(passwordEncryptor, userDataFile, adminName , userpassword,path);
        }
    }
