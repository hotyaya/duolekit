 ...
 *******************************************************************************/
package org.job.ui.browserexample;
...
public class BrowserExample {
	...
	public BrowserExample(Composite parent, boolean top,String url) {
		this.parent = parent;
		try {
...
//				event.browser = app.getBrowser();
		...
		if (top) {
			browser.setUrl(url);//getResourceString("Startup")//"http://10.64.3.55/gwcl/oagwcl.asp"
	...
	public static void main(String [] args) {
		...
		BrowserExample app = new BrowserExample(shell, true,"http://10.64.3.55/gwcl/oagwcl.asp");
		app.setShellDecoration(icon, true);
		shell.open();
