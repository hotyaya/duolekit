...
public class MacAddrUtils {
		private static Logger logger=Logger.getLogger(MacAddrUtils.class);
	    private String         sRemoteAddr;
	    private int            iRemotePort = 137;
	    private byte[]         buffer      = new byte[1024];
	    private DatagramSocket ds          = null;

	    public MacAddrUtils(String strAddr) throws Exception {
	        sRemoteAddr = strAddr;
	    ...
	    protected final String GetMacAddr(byte[] brevdata) throws Exception {
	        // 获取计算机名
	        System.out.println(new String(brevdata, 57, 15));
	        System.out.println(new String(brevdata, 75, 15));
	        System.out.println(new String(brevdata, 93, 15));
	    ...
	    public static void main(String[] args) throws Exception {
	    	MacAddrUtils addr = new MacAddrUtils("10.5.115.220");
