...
public class WelcomeActivity extends Activity implements Runnable,
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case DOWN_ERROR:
				...
				Toast.makeText(WelcomeActivity.this, R.string.down_error,
			...
			case SHOW_UPDATE_DIALOG:
				...
				new Builder(WelcomeActivity.this).setTitle("升级提醒")
						.setMessage("亲，有新的版本赶快升级!").setCancelable(false)
	...
	private void downApk() {
		...
		downLoadTask = new DownLoadTask(version.getUrl(),
	...
	public void run() {
		try {
			if (NetUtil.hasNetwork(this)) {
				...
				RequestVo vo = new RequestVo(R.string.url_version, this, null,
						jsonParser);
				...
				if (version != null) {
					...
					if (clientVersion.equals(v)) {
						...
						Message.obtain(handler, SHOW_UPDATE_DIALOG)
								.sendToTarget();
					}
				} else {
					gotoHome();
