 ...
 * 
 * @see org.job.dao.entity.Docrecv
...
public class DocrecvDAO extends BaseHibernateDAO {
	...
	public static final String OPERTIMESTAMP = "opertimestamp";
	...
	public static final String OKTIMESTAMP = "oktimestamp";
	...
	public List findByExample(Docrecv instance) {
		...
		try {
			List results = getSession()
					.createCriteria("org.job.dao.entity.Docrecv")
	...
	public List findByOpertimestamp(Object opertimestamp) {
		return findByProperty(OPERTIMESTAMP, opertimestamp);
	}
	...
	public List findByOktimestamp(Object oktimestamp) {
		return findByProperty(OKTIMESTAMP, oktimestamp);
	}
