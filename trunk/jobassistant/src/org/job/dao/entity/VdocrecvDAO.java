 ...
 * 
 * @see org.job.dao.entity.Vdocrecv
...
public class VdocrecvDAO extends BaseHibernateDAO {
	...
	public Vdocrecv findById(org.job.dao.entity.VdocrecvId id) {
		log.debug("getting Vdocrecv instance with id: " + id);
		try {
			Vdocrecv instance = (Vdocrecv) getSession().get(
					"org.job.dao.entity.Vdocrecv", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Vdocrecv instance) {
		...
		try {
			List results = getSession()
					.createCriteria("org.job.dao.entity.Vdocrecv")
