...
/**
 	* A data access object (DAO) providing persistence and search support for Docrecv entities.
...
public class DocrecvDAO extends BaseHibernateDAO  {
    ...
    public Docrecv findById( java.lang.Long id) {
        ...
        try {
            Docrecv instance = (Docrecv) getSession()
                    .get("railway.bj.admin.my.job.dao.entity.Docrecv", id);
            return instance;
        } catch (RuntimeException re) {
	...
	public List findByExample(Docrecv instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("railway.bj.admin.my.job.dao.entity.Docrecv")
    ...
    public Docrecv merge(Docrecv detachedInstance) {
        ...
        try {
            Docrecv result = (Docrecv) getSession()
