...
public class TagDAO extends BaseHibernateDAO {
	...
	public Tag findById(java.lang.Integer id) {
		...
		try {
			Tag instance = (Tag) getSession().get("my.outline.dao.entity.Tag",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Tag instance) {
		...
		try {
			List results = getSession()
					.createCriteria("my.outline.dao.entity.Tag")
	...
	public List findByPtagid(Object ptagid) {
		return findByProperty(PTAGID, ptagid);
	}
