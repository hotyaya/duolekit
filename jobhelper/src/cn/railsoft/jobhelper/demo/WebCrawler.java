package cn.railsoft.jobhelper.demo;
...
//	private SoftitemDAO dao = null;
	...
	public void doCrawler(){
		...
		try {
			...
			//中断的页面2012/09/18晚上继续；
			//str1 = "/cpcc/RRegisterAction.do?method=list&no=fck&sql_name=&sql_regnum=&sql_author=&sortLabel=registerDate&sortOrder=&curPage=754&count=10";
			
			
			
			//str1 = "/cpcc/RRegisterAction.do?method=list&no=fck&sql_name=&sql_regnum=&sql_author=&sortLabel=registerDate&sortOrder=&curPage=98&count=10";
