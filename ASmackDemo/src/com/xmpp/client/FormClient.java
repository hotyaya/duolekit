...
public class FormClient extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final Chat newchat = cm.createChat("user2@hotyaya-ge2w3vb", null);
			...
			public void chatCreated(Chat chat, boolean able) {
				chat.addMessageListener(new MessageListener() {
					...
					public void processMessage(Chat chat2, Message message) {
						...
						if(message.getFrom().contains("user2@hotyaya-ge2w3vb")){
							String[] args = new String[] { "user2", message.getBody(), TimeRender.getDate(), "IN" };
	...
	private void sendFile(String filepath) {
		...
		final OutgoingFileTransfer fileTransfer = fileTransferManager.createOutgoingFileTransfer("user2@hotyaya-ge2w3vb/Spark 2.6.3");				
